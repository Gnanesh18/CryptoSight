...
export function TrendingPanel({ data, isLoading, isDark, onCoinSelect }: TrendingPanelProps) {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className={cn('text-xs', isDark ? 'text-gray-500' : 'text-gray-400')}>{item.symbol.toUpperCase()}</p>
                  </div>
